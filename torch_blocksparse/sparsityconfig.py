...
class FixedSparsityConfig(SparsityConfig):
    ...
    def __init__(self,
                 ...
                 horizental_global_attention=False,
        ...
        if (attention != 'bidirectional' and horizental_global_attention):
            raise ValueError(
                'only \"bi-directional\" attentions can support horizental global attention!'
            )
    ...
    def set_global_layout(self, h):
        ...
        Note) if horizental_global_attention is set, global blocks will be set both horizentally and vertically.
        ...
        for i in range(first_global_block_idx, self.num_blocks, self.num_local_blocks):
            ...
            # horizental global attention
            if (self.horizental_global_attention):
